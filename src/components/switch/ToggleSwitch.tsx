  ...
  return (
    <div className={"switch__wrapper"}>
      <label className="switch">
        <input className="switch__input" type="checkbox" role="switch" onChange={onChange} defaultChecked={defaultChecked}/>
        ...
        <span className="switch__knob-container">
          <span className="switch__knob">
            <svg className="switch__knob-neon" viewBox="0 0 48 48" width="38px" height="38px">
